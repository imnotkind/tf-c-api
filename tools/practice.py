...
def frozen_fcn_pb():
    ...
    INPUT2 = graph.get_tensor_by_name("import/keep_probability:0") #is_training
    print(INPUT2)
...
def frozen_fcn_tflite():
    # Load TFLite model and allocate tensors.
    interpreter = tf.lite.Interpreter(model_path="model/frozen_fcn.tflite")
